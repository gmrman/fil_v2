define(["app", "API", "APIS", "ionic-popup"], function (app) {
   app.factory("kb_05_PopupService", ["APIService", "AppLang", "$rootScope", "$timeout", "$filter", "$ionicLoading", "$ionicPopup", "IonicClosePopupService", "IonicPopupService", "$ionicModal", "$ionicActionSheet", "userInfoService",
      function (APIService, AppLang, $rootScope, $timeout, $filter, $ionicLoading, $ionicPopup, IonicClosePopupService, IonicPopupService, $ionicModal, $ionicActionSheet, userInfoService) {
         ...
         return {
            ...
            "showWarehouseModal": function (warehouse, scaninfo, resolve, reject) {
               ...
               $ionicModal.fromTemplateUrl("views/app/kb_05/kb_05_s01/js/warehouseModal.html", {
                  "scope": $scope
               }).then(function (modal) {
            ...
            "showSingleModal": function (single, scaninfo, resolve, reject) {
               ...
               $ionicModal.fromTemplateUrl("views/app/kb_05/kb_05_s01/js/singleModal.html", {
                  "scope": $scope
               }).then(function (modal) {
                  $scope.close = function () {
