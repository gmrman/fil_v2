    ...
    return ['$scope', '$state', '$timeout', '$filter', 'AppLang', 'APIService', 'APIBridge',
        ...
        function($scope, $state, $timeout, $filter, AppLang, APIService, APIBridge,
            ...
            $scope.showQbeTodoNotice = function() {
                $ionicLoading.show();
                $ionicModal.fromTemplateUrl('views/app/xyc_fil_01/xyc_fil_01_s01/xyc_fil_01_s01_01.html', {
                    scope: $scope
                }).then(function(modal) {
            ...
            var app_todo_doc_get = function() {
                var webTran = {
                    ...
                    service: 'app.xGetSalesDelivery.get',
                    parameter: {
                        "program_job_no": $scope.page_params.program_job_no,
            ...
            if (!commonService.isNull(xyc_fil_01_requisition.scanning)) {
                var scanning = angular.copy(xyc_fil_01_requisition.scanning);
                xyc_fil_01_requisition.scanning = "";
                $scope.getInfo({
                    "doc_no": scanning,
                    "seq": "",
                });
