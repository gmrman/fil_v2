    ...
    return ['$scope', '$state', '$stateParams', '$timeout', '$filter', 'AppLang', 'APIService', 'APIBridge',
        ...
        function($scope, $state, $stateParams, $timeout, $filter, AppLang, APIService, APIBridge,
            ...
            $scope.splitGoods = function(index) {
                ...
                var checkSplitItem = function(parameter) {
                    ...
                    if ($scope.selbarcodedata.length == 1) {
                        ...
                        $ionicModal.fromTemplateUrl('views/app/fil_common/fil_common_s07/selbarcodedata.html', {
                            scope: $scope
                        }).then(function(modal) {
                ...
                $ionicModal.fromTemplateUrl('views/app/fil_common/fil_common_s07/splitItemModal.html', {
                    scope: $scope
                }).then(function(modal) {
            ...
            $scope.selItemPopShow = function(scanning, source_doc_detail) {
                ...
                $ionicModal.fromTemplateUrl('views/app/fil_common/fil_common_s07/selItemModal.html', {
                    scope: $scope
                }).then(function(modal) {
            ...
            var showSetLot = function(index, parameter) {
                ...
                $ionicModal.fromTemplateUrl('views/app/fil_common/fil_common_s07/setLotModal.html', {
                    scope: $scope
                }).then(function(modal) {
                    $scope.close = function() {
                        modal.hide().then(function() {
