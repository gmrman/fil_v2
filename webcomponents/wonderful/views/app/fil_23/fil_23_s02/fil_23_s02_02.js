define(["API", "APIS", 'AppLang', 'ionic-popup', "circulationCardService", "Directives", "ReqTestData", "commonFactory",'userInfoService'], function() {
    return ['$scope', '$state', '$ionicLoading', 'AppLang', 'IonicPopupService', 'APIService', '$timeout',
        'APIBridge', "ReqTestData", "circulationCardService", "commonFactory", 'userInfoService',"$ionicPopup", "IonicClosePopupService", "$filter", "$ionicModal", '$ionicListDelegate',
