...
TYPE detail                RECORD
      ...
      unit                    LIKE app_base_bcme_t.bcme035, #揀貨單位
      multi_unit_type         LIKE app_base_bcme_t.bcme057, #多單位的單位控管方式
      reference_unit_no       LIKE app_base_bcme_t.bcme032, #參考單位
      already_ref_qty         LIKE app_base_bcme_t.bcme033, #參考數量
      should_ref_qty          LIKE app_base_bcme_t.bcme033, #參考數量
      valuation_unit_no       LIKE app_base_bcme_t.bcme055, #計價單位
      already_val_qty         LIKE app_base_bcme_t.bcme056, #計價數量
      should_val_qty          LIKE app_base_bcme_t.bcme056, #計價數量
      inventory_unit          LIKE app_base_bcme_t.bcme048, #庫存單位
      already_inv_qty         LIKE app_base_bcme_t.bcme058, #庫存數量
      should_inv_qty          LIKE app_base_bcme_t.bcme058, #庫存數量
      main_warehouse_no       LIKE app_base_bcme_t.bcme059, #主要倉庫
      main_storage_no         LIKE app_base_bcme_t.bcme060  #主要儲位
                           END RECORD
PUBLIC FUNCTION bcme_get(p_json)
   ...
   DEFINE l_bcme           RECORD
            bcme010           LIKE app_base_bcme_t.bcme010,
            bcme011           LIKE app_base_bcme_t.bcme011,
            bcme012           LIKE app_base_bcme_t.bcme012,
            bcme043           LIKE app_base_bcme_t.bcme043,
            bcme044           LIKE app_base_bcme_t.bcme044,
            bcme057           LIKE app_base_bcme_t.bcme057, #多單位的單位控管方式
            bcme035           LIKE app_base_bcme_t.bcme035, #揀貨單位
            bcme017           LIKE app_base_bcme_t.bcme017,
            bcme017_sum       LIKE app_base_bcme_t.bcme017,
            bcme032           LIKE app_base_bcme_t.bcme032, #參考單位
            bcme033           LIKE app_base_bcme_t.bcme033, #參考數量
            bcme033_sum       LIKE app_base_bcme_t.bcme033, #參考數量
            bcme055           LIKE app_base_bcme_t.bcme055, #計價單位
            bcme056           LIKE app_base_bcme_t.bcme056, #計價數量
            bcme056_sum       LIKE app_base_bcme_t.bcme056, #計價數量
            bcme048           LIKE app_base_bcme_t.bcme048, #庫存單位
            bcme058           LIKE app_base_bcme_t.bcme058, #庫存數量
            bcme058_sum       LIKE app_base_bcme_t.bcme058, #庫存數量  
            bcme059           LIKE app_base_bcme_t.bcme059, #主要倉庫
            bcme060           LIKE app_base_bcme_t.bcme060  #主要儲位          
                           END RECORD
