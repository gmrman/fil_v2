...
PUBLIC FUNCTION xyc_bcme_ae_af_get(p_json)
   ...
   IF r_obj[1].submit_show THEN
      ...
      LET l_sql = " SELECT bcaf006,    bcaf007,    bcaf008,    bcaf009,    bcafname,  ",
                  ...
                  "        bcafMunit,  bcafPcode,  bcafPqty,   bcaf001  , xshipping_mark_no ,xshipping_mark_cn                                        ",
