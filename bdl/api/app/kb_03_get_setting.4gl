...
PUBLIC FUNCTION kb_03_get_setting(p_json)
   ...
   DEFINE l_master   RECORD                        
             ...
             site       LIKE capp_receipt_kb_t.site       #營業據點                                   
                     END RECORD
   DEFINE l_i            INTEGER
   DEFINE l_warehouse    type_capp_kb_03_warehouse_t
   DEFINE l_single       type_capp_kb_03_single_t
